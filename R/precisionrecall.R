...
#' 
#' @param w Numeric vector: Each entry represents one intersection. Proportion of texts in this intersection.
#' @param p Numeric vector: Each entry represents one intersection. Proportion of relevant texts in this intersection.
#' @param subset Logical vector: Each entry represents one intersection. Controls if the intersection belongs to the subcorpus of interest or not.
